...
def index(request):
    ...
    return render(request, 'cells/index.html', context)
...
def new(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('articles:detail', cell.pk)
    ...
    return render(request, 'cells/new.html', context)


# def detail(request, pk):
#     # Database에서 data 가져오기
#     article = Cell.objects.get(pk=pk)
#
#     # 댓글 작성 양식 가져오기
...
def edit(request, pk):
    ...
    return render(request, 'cells/edit.html', context)
